...
const USERNAME = process.env.GITHUB_REPOSITORY_OWNER || "liambrockpy"
...
async function generateMSN() {
	...
	const onlineContacts = following
		...
		.map((f, i) => {
			const yPos = 213 + i * 18
			const isAway = i % 2 === 1 // Alternate some as "away"
			return `
      <g>
        <!-- Status icon -->
  ...
  <defs>
    ...
    <linearGradient id="titlebar" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" style="stop-color:#0A246A"/>
      <stop offset="8%" style="stop-color:#0A246A"/>
      <stop offset="10%" style="stop-color:#A6CAF0"/>
      <stop offset="90%" style="stop-color:#0A246A"/>
      <stop offset="100%" style="stop-color:#0A246A"/>
    </linearGradient>
    
    <!-- Title bar shine effect -->
    ...
    <!-- MSN Buddy icon colors -->
    <linearGradient id="buddyGreen" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#4AC94A"/>
      <stop offset="100%" style="stop-color:#2E8B2E"/>
    </linearGradient>
    <linearGradient id="buddyBlue" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#4A90C9"/>
  ...
  <!-- MSN Buddy Icon (two people silhouette) -->
  <g transform="translate(14, 52)">
    <rect x="0" y="0" width="52" height="50" fill="#B8CCE8" stroke="#8CAAD4" stroke-width="1" rx="3"/>
    <!-- Green person (front) -->
    <ellipse cx="20" cy="18" rx="8" ry="9" fill="url(#buddyGreen)"/>
    <ellipse cx="20" cy="38" rx="12" ry="10" fill="url(#buddyGreen)"/>
    <!-- Blue person (back) -->
    <ellipse cx="34" cy="14" rx="7" ry="8" fill="url(#buddyBlue)"/>
    <ellipse cx="34" cy="32" rx="10" ry="9" fill="url(#buddyBlue)"/>
  </g>
  ...
  <g transform="translate(6, 120)">
    ...
    <g transform="translate(6, 4)">
      <ellipse cx="4" cy="6" rx="4" ry="5" fill="#FF6B35"/>
      <ellipse cx="12" cy="6" rx="4" ry="5" fill="#FFB800"/>
      <ellipse cx="4" cy="12" rx="3" ry="4" fill="#00A4EF"/>
      <ellipse cx="12" cy="12" rx="3" ry="4" fill="#7FBA00"/>
      <ellipse cx="8" cy="9" rx="2" ry="5" fill="#555"/>
    </g>
  ...
  <!-- Bottom MSN branding -->
  <g transform="translate(55, 408)">
    <!-- MSN Butterfly -->
    <g transform="translate(0, 0) scale(0.7)">
      <ellipse cx="8" cy="8" rx="7" ry="9" fill="#FF6B35"/>
      <ellipse cx="22" cy="8" rx="7" ry="9" fill="#FFB800"/>
      <ellipse cx="8" cy="22" rx="6" ry="8" fill="#00A4EF"/>
      <ellipse cx="22" cy="22" rx="6" ry="8" fill="#7FBA00"/>
      <ellipse cx="15" cy="15" rx="3" ry="8" fill="#333"/>
    </g>
    <text x="26" y="18" font-family="Arial, sans-serif" font-size="14" fill="#333" font-style="italic" font-weight="bold">
      msn
    </text>
    <text x="52" y="18" font-family="Times New Roman, serif" font-size="14" fill="#333">
      Messenger
    </text>
  </g>
  
  <!-- Window border (bottom and right shadow) -->
